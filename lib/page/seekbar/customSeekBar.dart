...
class _SeekBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // final rect = Rect.fromCircle(center: Offset.zero, radius: indicatorRadius);
    // 画当前显示的值的指示器
    void drawIndicator() {
      ...
      final rect = Rect.fromCircle(center: Offset(value * size.width, size.height), radius: indicatorRadius);
      ...
      canvas.drawCircle(Offset(value * size.width, size.height / 2),indicatorRadius,  borderPaint);
    }
